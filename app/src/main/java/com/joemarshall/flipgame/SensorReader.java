    ...
    public void onSensorChanged(SensorEvent arg0)
    {
        try
        {
            if(arg0.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR)
            {
                ...
                m_EventMethod.invoke(m_Parent,
                                     new Object[]{arg0.sensor.getType(), orientationVec[0],
                                             orientationVec[1], orientationVec[2], arg0.timestamp,
                                             arg0.accuracy});
            } else
            {
                m_EventMethod.invoke(m_Parent, new Object[]{arg0.sensor.getType(), arg0.values[0],
                        arg0.values[1], arg0.values[2], arg0.timestamp, arg0.accuracy});
            }
